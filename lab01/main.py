...
Label(root, text="Input points:").place(x=20, y=30)
pointsEntry = StringVar(root)
Entry = ttk.Entry(root, textvariable=pointsEntry).place(x=20, y=58)

ShowPointsButton = Button(root, text="Show points", command= lambda: showPoints(canvas, pointsList)).place(x=20, y=90)
ShowTriangleButton = Button(root, text="Show triangle", command= lambda: showTriangle(canvas, pointsList)).place(x=120, y=90)
